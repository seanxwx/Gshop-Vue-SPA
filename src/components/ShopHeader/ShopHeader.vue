  ...
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          <span class="shop-message-detail">Rate: {{info.score}}</span>
          <span class="shop-message-detail">{{info.sellCount}} Orders Per Month</span>
          <span class="shop-message-detail">
            {{info.description}}
            <span>Approx {{info.deliveryTime}} min</span>
          </span>
          <span class="shop-message-detail">About {{info.distance}}</span>
        </div>
      </div>
    </div>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">
      ...
      <div class="discounts-right">
        {{info.supports.length}} promotions
      </div>
    </div>
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <ul class="brief-modal-msg">
            ...
            <li>
              <h3>{{info.sellCount}} orders</h3>
              <p>Per Month</p>
            </li>
            <li>
              <h3>{{info.description}}</h3>
              <p>Approx {{info.deliveryTime}} mins</p>
            </li>
            <li>
