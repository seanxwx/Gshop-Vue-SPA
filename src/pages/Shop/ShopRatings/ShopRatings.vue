			...
			<div class="overview">
				...
				<div class="overview-right">
					<div class="score-wrapper">
						<span class="title">Service Rating:&nbsp;</span>
						<Star :score="info.serviceScore" :size="36" />
						<span class="score">{{info.serviceScore}}</span>
					</div>
					<div class="score-wrapper">
						<span class="title">Product Rating:&nbsp;</span>
						<Star :score="info.foodScore" :size="36" />
						<span class="score">{{info.foodScore}}</span>
					</div>
					<div class="delivery-wrapper">
						<span class="title">Delivery Time</span>
						<span class="delivery">{{info.deliveryTime}} mins</span>
					</div>
				</div>
			</div>
			<div class="split"></div>
			<div class="ratingselect">
				<div class="rating-type border-1px">
					...
					<span class="block positive" :class="{active: selectType===0}" @click="setSelectType(0)">
						Good  <span class="count">{{positiveSize}}</span>
					</span>
					<span class="block negative" :class="{active: selectType===1      }" @click="setSelectType(1)">
						Bad <span class="count">{{ratings.length - positiveSize}}</span>
					</span>
...
export default {
	data(){
		return {
			onlyShowText: true, //if only show text
			selectType: 2 //selected rating type : 0 - satisfy 1 - unsatisify 2- all
		}
	},
